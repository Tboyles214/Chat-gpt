  ...
  return (
    ...
    <div className="mb-8 space-y-4">
      ...
      <p className="text-muted-foreground font-light text-sm md:text-lg text-center">
        Genius is a web application that uses the power of AI to generate
        content. It is a tool that can be used by anyone to generate content
        such as music, code, and video.
      </p>
